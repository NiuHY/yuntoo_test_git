package com.yt.webviewtest.SafeWebViewBridge.js;
...
import com.yt.webviewtest.activity.DetailPageActivity;
...
public class JsScope {
    ...
    public static void startActivity(WebView webView, String url, int category, String activityName){
        //拼接包名
        String className = "com.yt.webviewtest.activity." + activityName;
        //得到字节码
        try {
    ...
    private static void start(WebView webView, String url, int category, Class cla){
        ...
        if (context instanceof Activity){
            ...
            context.startActivity(intent);//开启详情页
            // 开启动画
            ((Activity) context).overridePendingTransition(R.anim.setg_next_in, R.anim.setg_next_out);
        }
    }
